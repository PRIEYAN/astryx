...
}`,...P.parameters?.docs?.source},description:{story:"`modality` controls interaction; `hasScrim` controls paint. Their defaults\nmatch, while all four combinations remain available for future products.\nA non-modal scrim is visual only and does not intercept the page behind it.",...P.parameters?.docs?.description}}},F=[`Showcase`,`RowInspector`,`Bounded`,`BoundedInAScrollingPane`,`Sides`,`Widths`,`MobileWidth`,`FloatsOverContent`,`Scrim`]}))();export{O as Bounded,k as BoundedInAScrollingPane,N as FloatsOverContent,M as MobileWidth,D as RowInspector,P as Scrim,E as Showcase,A as Sides,j as Widths,F as __namedExportsOrder,C as default};